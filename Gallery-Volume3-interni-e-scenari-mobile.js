...
<head>
  ...
  <style>
    ...
    /* Container interno per lo slider */
    ...
    .details-gallery-mobile .title-wrapper-gallery-mobile {
      display: flex;
    ...
    .details-gallery-mobile h1 {
      font-family: "SF Pro Display", sans-serif !important;
      font-size: 24px;
      font-weight: 600;
      color: black;
    }
    .details-gallery-mobile .subtitle {
      font-family: "SF Pro Display", sans-serif !important;
      font-size: 24px;
      font-weight: 600;
      color: #6e6e73;
    ...
    /* Spinner e progress frame per il download ZIP */
    .spinner-mobile {
      display: none;
      position: absolute;
      bottom: 10px;
...
<body>
  <!-- Contenitore in cui viene iniettata la gallery -->
  <div id="gallery-container-mobile"></div>
  ...
  <script>
    (function() {
      ...
      // In questo esempio il CSS è già stato inserito nell'header
      // quindi non è necessario richiamare addStyle()

      // Nuovo HTML della gallery, con il blocco dettagli spostato fuori dal container dello slider
      var galleryHTML = `
        <div class="wrapper-slider-mobile">
          ...
          <!-- Blocco dei dettagli, spostato fuori dal container dello slider -->
      ...
      // Inietta la gallery nel contenitore con ID "gallery-container-mobile"
      function injectGallery() {
        ...
        if (container) {
          ...
          console.warn("Elemento con ID 'gallery-container-mobile' non trovato. Iniettato in body come fallback.");
        }
      }
      injectGallery();

      // Funzione per caricare uno script esterno (per JSZip)
      ...
      function initGallery() {
        ...
        function createIndicators() {
          ...
          images.forEach(function(_, idx) {
            ...
            dot.className = "indicator-mobile" + (idx === 0 ? " active" : "");
