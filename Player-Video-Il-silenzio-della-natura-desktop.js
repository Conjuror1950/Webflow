// player-video-silenzio-natura.js
// This module injects the video player HTML into a container with the specified ID.

/**
 * Initialize the video player by injecting the HTML structure into the container.
 * @param {string} containerId - The ID of the div where the player will be embedded.
 */
export function initVideoPlayer(containerId = 'Player-Video-Il-silenzio-della-natura-container-desktop') {
            ...
            <div class="right-controls">
              ...
              <button class="lang-btn">
                <img src="https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/681bb7eb7c5e96fc0889f14c_waveform.circle.svg"
                     alt="Lingua" style="width:20px; height:20px;">
              </button>
              ...
              <button class="share-btn">
                <img src="https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/681c7cf63258616ead57cdf0_square.and.arrow.up.svg"
                     alt="Condividi" style="width:18px; height:30px;">
              </button>
              ...
              <button class="fullscreen-btn">
                <img src="https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/681a6105f7d436f1d44084d0_arrow.up.backward.and.arrow.down.forward.svg"
                     alt="Fullscreen" style="width:18px; height:18px;">
              </button>
            </div>
          </div>
