...
<img src="https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/68288c23d64340a80e1a52e1_avviso%20et%C3%A0.png" alt="Avviso: età" class="warning-age">
  ...
  <div class="controls">
    <div class="top-bar">
      ...
      <img src="https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/681a6e03d818ab9f59079de2_xmark.svg" alt="Close" class="close-btn" style="width:18px; height:18px;">
          </button>
  ...
  <img src="https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/681a5fb8f7a09fb00f328afb_10.arrow.trianglehead.clockwise.svg" alt="Forward 10" style="height:35px;">
    ...
    <div class="bottom-bar">
      <!-- nuova riga superiore: titolo a sinistra, controlli a destra -->
...
<div class="subs-menu" style="display:none;">
  ...
  <button class="subs-item selected" data-val="0">Italiano (automatico)</button>   <!-- <- selected -->
</div>
          <!-- Language switcher -->
          <button class="lang-btn">
           ...
           <button class="title-lang-item">Audio</button>
            <button class="lang-item" data-lang="it">Originale: Italiano<span class="check">✓</span>
 </button>
          </div>
    ...
    <button class="share-item email-share">
      ...
      <img class="item-icon" src="https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/681b6628ed25af24c9b87b32_envelope.fill.svg" width="18" height="18" alt="Email Icon">
          ...
          <button class="fullscreen-btn">
           <img src="https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/681a6105f7d436f1d44084d0_arrow.up.backward.and.arrow.down.forward.svg" alt="Fullscreen" class="fullscreen-icon" style="width:18px; height:18px;">
          </button>
        </div>
      </div>
      <!-- wrapper relativo per scrub thumb -->
      <div class="progress-wrapper" style="position:relative;">
      <input type="range" class="progress" value="0" step="0.1">
      <!-- questo è il pallino bianco che seguirà il mouse -->
      <div class="scrub-thumb"></div>
    </div>
      <!-- dentro .bottom-bar, subito dopo <input class="progress"> -->
<div class="preview-container" style="display:none;">
  <video id="preview-video" muted preload="metadata" crossorigin="anonymous"></video>
    <!-- Nuovo contenitore per i sottotitoli della preview -->
  <div id="preview-subtitles" class="subtitle-container"></div>
     <!-- timecode centrato in basso -->
...
(function() {
  ...
  // CSS del player (stile completo), con media query per desktop (>= 1280px)
  var playerCSS = `
