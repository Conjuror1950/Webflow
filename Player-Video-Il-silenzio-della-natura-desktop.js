/* Inserisce un player video con controlli personalizzati in un contenitore specificato. @param {string} containerId - L'id dell'elemento DOM in cui inserire il player.*/
export function initAppleVideoEmbed(containerId) {
  const container = document.getElementById(Player-Video-Il-silenzio-della-natura-container-desktop);
  if (!container) {
    console.error(`Container with id "${Player-Video-Il-silenzio-della-natura-container-desktop}" not found.`);
    return;
  }
        ...
        <div class="bottom-top-row">
          ...
          <div class="right-controls">
            ...
            <button class="lang-btn">
              <img src="https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/681bb7eb7c5e96fc0889f14c_waveform.circle.svg" alt="Lingua" class="lang-icon" style="width:20px; height:20px;">
            </button>
            ...
            <button class="share-btn">
              <img src="https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/681c7cf63258616ead57cdf0_square.and.arrow.up.svg" alt="Condividi" style="width:18px; height:30px;">
            </button>
