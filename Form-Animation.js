...
// Inserimento immediato overlay e CSS
...
overlay.innerHTML = `
  <div class="lock-message" style="display:flex;flex-direction:column;align-items:center;gap:0.5rem">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.9668 19.5986" style="width:2.5rem;height:2.5rem;color:black;opacity:0.95">
      <g><rect height="19.5986" opacity="0" width="23.9668" x="0" y="0"/>
...
// Funzione di controllo istantanea
const updateOverlay = () => {
  const landscapeMobile = window.innerWidth <= 767 && window.innerWidth > window.innerHeight;
  overlay.style.opacity = landscapeMobile ? '1' : '0';
  overlay.style.visibility = landscapeMobile ? 'visible' : 'hidden';
  overlay.style.pointerEvents = landscapeMobile ? 'all' : 'none';
};

// Event listener ultra-rapidi
...
// Controllo immediato all’inizio
updateOverlay();
});
