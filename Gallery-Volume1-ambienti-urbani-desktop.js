(function() {
  ...
  var galleryCSS = `
    ...
    .wrapper-slider-Volume1-ambienti-urbani-desktop {
      display: flex;
    ...
    .container-Volume1-ambienti-urbani-desktop {
      display: flex;
      width: 100%;
      align-items: flex-start;
    ...
    /* --- SLIDER --- */
    .slider-Volume1-ambienti-urbani-desktop {
      position: relative;
      padding: 50px 0;
      overflow: hidden;
      display: flex;
    ...
    .slides-Volume1-ambienti-urbani-desktop {
      display: flex;
      transition: transform 0.3s ease-in-out;
    }
    .slide-Volume1-ambienti-urbani-desktop {
      min-width: 100%;
      flex-shrink: 0;
      display: flex;
      justify-content: center;
    ...
    .product-image-Volume1-ambienti-urbani-desktop {
      max-height: 65vh;
      max-width: 100%;
      object-fit: contain;
      border-radius: 2%;
    ...
    .product-image-Volume1-ambienti-urbani-desktop:hover {
      transform: scale(1.0);
    }
    /* Pulsanti per lo slider */
    .slider-buttons-Volume1-ambienti-urbani-desktop {
      position: absolute;
      top: 50%;
      left: 0;
      right: 0;
    ...
    .slider-button-Volume1-ambienti-urbani-desktop {
      position: absolute;
      background: #d3d3d3;
      border: none;
      width: 55px;
    ...
    .slider-button-Volume1-ambienti-urbani-desktop.prev {
      left: 20px;
      transform: translateY(-50%);
    }
    .slider-button-Volume1-ambienti-urbani-desktop.next {
      right: 20px;
      transform: translateY(-50%);
    }
    .slider-button-Volume1-ambienti-urbani-desktop:hover {
      background: rgba(211, 211, 211, 0.75);
      color: rgba(29, 29, 29, 0.90);
    }
    /* Indicatori delle slide */
    .slider-indicators-Volume1-ambienti-urbani-desktop {
      position: absolute;
      bottom: 15px;
      left: 50%;
    ...
    .indicator-Volume1-ambienti-urbani-desktop.active {
      background: #1d1d1d;
    }
    ...
    /* --- DETTAGLI --- */
    .details-Volume1-ambienti-urbani-desktop {
      width: 18%;
      text-align: left;
      padding: 50px;
    ...
    .option-button-Volume1-ambienti-urbani-desktop {
      display: flex;
      flex-direction: column;
      gap: 10px;
    }
    .option-Volume1-ambienti-urbani-desktop {
      background: white;
    ...
    .option-Volume1-ambienti-urbani-desktop:hover,
    .option-Volume1-ambienti-urbani-desktop.selected {
      border-color: #0071e3;
    }
    .option-main-Volume1-ambienti-urbani-desktop {
      display: flex;
      justify-content: space-between;
      align-items: center;
    }
    .option-title-Volume1-ambienti-urbani-desktop {
      font-size: 16px;
      font-weight: 600;
      color: #1d1d1f;
    }
    .option-side-Volume1-ambienti-urbani-desktop {
      font-size: 13px;
      color: #86868b;
      margin-left: 10px;
      white-space: nowrap;
    }
    .option-subtext-Volume1-ambienti-urbani-desktop {
      font-size: 13px;
      color: #86868b;
      margin-top: 6px;
    }
    .info-box-Volume1-ambienti-urbani-desktop {
      width: 250%;
      background: #f7f7f7;
      border-radius: 12px;
      padding: 16px;
    ...
    .additional-info-Volume1-ambienti-urbani-desktop {
      width: 250%;
      background: transparent;
      border-radius: 12px;
      padding: 16px;
    ...
    .info-bold-Volume1-ambienti-urbani-desktop {
      font-weight: 600;
      font-size: 14px;
      margin-bottom: 4px;
    }
    .info-regular-Volume1-ambienti-urbani-desktop {
      font-size: 13px;
      line-height: 1.4;
    }
    .title-wrapper-Volume1-ambienti-urbani-desktop {
      display: flex;
    ...
    .subtitle-Volume1-ambienti-urbani-desktop {
      font-family: "SF Pro Display", sans-serif !important;
      font-size: 24px;
      font-weight: 600;
      color: #6e6e73;
    ...
    .spinner-Volume1-ambienti-urbani-desktop {
      display: none;
      position: absolute;
      bottom: 10px;
      right: 20px;
    ...
    .progress-frame-Volume1-ambienti-urbani-desktop {
      width: 100%;
      height: 100%;
      border-radius: 50%;
    ...
    .progress-frame-Volume1-ambienti-urbani-desktop::after {
      content: "";
      width: 80%;
      height: 80%;
      background: white;
    ...
    /* Fullscreen */
    :fullscreen .slider-Volume1-ambienti-urbani-desktop,
    :-webkit-full-screen .slider-Volume1-ambienti-urbani-desktop,
    :-moz-full-screen .slider-Volume1-ambienti-urbani-desktop,
    :-ms-fullscreen .slider-Volume1-ambienti-urbani-desktop {
      width: 100vw;
      height: 100vh;
      border-radius: 0;
      padding: 0;
    }
    :fullscreen .slides-Volume1-ambienti-urbani-desktop,
    :-webkit-full-screen .slides-Volume1-ambienti-urbani-desktop {
      height: 100%;
    }
    :fullscreen .slide-Volume1-ambienti-urbani-desktop {
      height: 100%;
      display: flex;
      justify-content: center;
      align-items: center;
    }
    :fullscreen .product-image-Volume1-ambienti-urbani-desktop {
      max-width: 100%;
      max-height: 100%;
      object-fit: contain;
      border-radius: 2%;
    }
    :fullscreen .slider-buttons-Volume1-ambienti-urbani-desktop,
    :fullscreen .slider-indicators-Volume1-ambienti-urbani-desktop,
    :fullscreen .slide-count-Volume1-ambienti-urbani-desktop {
      z-index: 10;
    }
    /* Titoli sopra e sotto lo slider */
    .slider-title-top-Volume1-ambienti-urbani-desktop {
      font-family: "SF Pro Display", sans-serif !important;
      text-align: left;     
      color: black;
      margin-top: 60px;
    ...
    .slider-title-top-Volume1-ambienti-urbani-desktop p {
      font-family: "SF Pro Display", sans-serif !important;
      font-weight: 500;
      font-size: 13px;
      color: #86868b;
    }
    .slider-title-bottom-Volume1-ambienti-urbani-desktop {
      font-family: "SF Pro Display", sans-serif !important;
      max-width: 970px;
      text-align: left;     
      color: black;
    ...
    .slider-title-bottom-Volume1-ambienti-urbani-desktop h2 {
      font-family: "SF Pro Display", sans-serif !important;
      font-weight: 600;
      font-size: 14px;
      margin-bottom: -2px;
    }
    .slider-title-bottom-Volume1-ambienti-urbani-desktop p {
      font-family: "SF Pro Display", sans-serif !important;
      font-weight: 400;
      font-size: 13px;
      color: #86868b;
      ...
      <div class="container-Volume1-ambienti-urbani-desktop">
        <div class="slider-Volume1-ambienti-urbani-desktop">
          ...
          <div class="slide-count-Volume1-ambienti-urbani-desktop">
            <span id="slide-counter-Volume1-ambienti-urbani-desktop">1 di 80</span>
          </div>
        </div>
        <div class="details-Volume1-ambienti-urbani-desktop">
          <div class="title-wrapper-Volume1-ambienti-urbani-desktop">
            <h1>Download.</h1>
            <span class="subtitle-Volume1-ambienti-urbani-desktop">Quale scegli?</span>
          </div>
          <div class="option-button-Volume1-ambienti-urbani-desktop">
            <div class="option-Volume1-ambienti-urbani-desktop" id="download-single-Volume1-ambienti-urbani-desktop">
              <div class="option-main-Volume1-ambienti-urbani-desktop">
                <span class="option-title-Volume1-ambienti-urbani-desktop">Immagine selezionata</span>
                <span class="option-side-Volume1-ambienti-urbani-desktop">.jpg¹</span>
              </div>
              <div class="option-subtext-Volume1-ambienti-urbani-desktop">Qualità originale, HD</div>
              <div class="option-subtext-Volume1-ambienti-urbani-desktop">1 elemento, ~3 MB</div>
            </div>
            <div class="option-Volume1-ambienti-urbani-desktop" id="download-all-Volume1-ambienti-urbani-desktop">
              <div class="option-main-Volume1-ambienti-urbani-desktop">
                <span class="option-title-Volume1-ambienti-urbani-desktop">Intero volume</span>
            ...
            <div class="info-box-Volume1-ambienti-urbani-desktop">
              <div class="info-bold-Volume1-ambienti-urbani-desktop">Panoramica del contenuto</div>
              <div class="info-regular-Volume1-ambienti-urbani-desktop">Una raccolta di fotografie che cattura la vita e i panorami delle città. Dalle strade affollate agli scorci unici, ogni immagine racconta l’energia e la dinamicità dell’ambiente urbano.</div>
            </div>
            <div class="additional-info-Volume1-ambienti-urbani-desktop">
              <div class="info-bold-Volume1-ambienti-urbani-desktop">Espandi</div>
              <div class="info-regular-Volume1-ambienti-urbani-desktop">Tocca un'immagine per vederla a tutto schermo.</div>
            </div>
          </div>
        </div>
      </div>
      <div class="slider-title-bottom-Volume1-ambienti-urbani-desktop">
        <h2>Specifiche</h2>
        ...
        <p>· Scatti 18-20: Viareggio, Toscana, Italia · 2024</p>
        <p>· Scatti 21-66: Parigi, Francia, Europa · 27 lug – 1 ago 2023</p>
  ...
  function injectGallery() {
    var container = document.getElementById("Volume1-ambienti-urbani-container-desktop");
    if (container) {
      ...
      console.warn("Elemento con ID 'Volume1-ambienti-urbani-container-desktop' non trovato. Iniettato in body come fallback.");
    }
  }
  injectGallery();
  ...
  function initGallery() {
    var images = [
      ...
      { url: "https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/66dc665d1b0945b4a41741f9__MG_7585.jpg", name: "MG_7585.jpg" },
      ...
      { url: "https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/66dc665c18ffc46b3d1bf71c__MG_7750.jpg", name: "MG_7750.jpg" },
      { url: "https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/66dc665818ffc46b3d1bf48c__MG_7766.jpg", name: "MG_7766.jpg" },
      ...
      { url: "https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/66dc665cc2f99b295b9482a5__MG_8186.jpg", name: "MG_8186.jpg" },
      ...
      { url: "https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/66dc6658e38da854fef60fbf__MG_8310.jpg", name: "MG_8310.jpg" },
      ...
      { url: "https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/66dc665639706fc65eb410a7__MG_8412.jpg", name: "MG_8412.jpg" },
      ...
      { url: "https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/66dc66633e9746942cd747bf__MG_8658.jpg", name: "MG_8658.jpg" },
      { url: "https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/66dc6656c5e6c9bbd146dc85__MG_8659.jpg", name: "MG_8659.jpg" },
      { url: "https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/66dc665bd8e5c09607102b6e__MG_8689.jpg", name: "MG_8689.jpg" },
      ...
      { url: "https://cdn.prod.website-files.com/6612d92ea994c2c00b892543/6807decbd46245d21966444e_MG_4123.jpg", name: "MG_4123.jpg" },
    ...
    function createSlides() {
      var slidesContainer = document.querySelector(".slides-Volume1-ambienti-urbani-desktop");
      images.forEach(function(img, index) {
        var slide = document.createElement("div");
        slide.className = "slide-Volume1-ambienti-urbani-desktop";
        var imageEl = document.createElement("img");
        imageEl.src = img.url;
        imageEl.alt = "Image " + (index + 1);
        imageEl.className = "product-image-Volume1-ambienti-urbani-desktop";
    ...
    function createIndicators() {
      var indicatorContainer = document.querySelector(".slider-indicators-Volume1-ambienti-urbani-desktop");
      images.forEach(function(_, idx) {
        var dot = document.createElement("div");
        dot.className = "indicator-Volume1-ambienti-urbani-desktop" + (idx === 0 ? " active" : "");
    ...
    function updateSlideCounter() {
      document.getElementById("slide-counter-Volume1-ambienti-urbani-desktop").textContent = (slideIndex + 1) + " di " + images.length;
    }
    
    // Aggiorna la visibilità dei pulsanti
    function updateSliderButtons() {
      document.querySelector(".slider-button-Volume1-ambienti-urbani-desktop.prev").style.display = slideIndex === 0 ? "none" : "flex";
      document.querySelector(".slider-button-Volume1-ambienti-urbani-desktop.next").style.display = slideIndex === images.length - 1 ? "none" : "flex";
    }
    
    // Aggiorna gli indicatori attivi
    function updateIndicators() {
      var dots = document.querySelectorAll(".indicator-Volume1-ambienti-urbani-desktop");
    ...
    function moveToSlide(index) {
      slideIndex = index;
      document.querySelector(".slides-Volume1-ambienti-urbani-desktop").style.transform = "translateX(-" + (slideIndex * 100) + "%)";
      updateIndicators();
      updateSliderButtons();
      updateSlideCounter();
    }
    ...
    document.querySelector(".slider-button-Volume1-ambienti-urbani-desktop.next").addEventListener("click", function() {
      if (slideIndex < images.length - 1) {
        moveToSlide(slideIndex + 1);
      }
    });
    document.querySelector(".slider-button-Volume1-ambienti-urbani-desktop.prev").addEventListener("click", function() {
      if (slideIndex > 0) {
        moveToSlide(slideIndex - 1);
      }
    });
    ...
    document.querySelectorAll(".product-image-Volume1-ambienti-urbani-desktop").forEach(function(image) {
      image.addEventListener("click", function() {
        var slider = document.querySelector(".slider-Volume1-ambienti-urbani-desktop");
    ...
    document.getElementById("download-single-Volume1-ambienti-urbani-desktop").addEventListener("click", function() {
      var currentSlide = document.querySelectorAll(".slide-Volume1-ambienti-urbani-desktop")[slideIndex];
    ...
    var downloadAllButton = document.getElementById("download-all-Volume1-ambienti-urbani-desktop");
    var spinner = downloadAllButton.querySelector(".spinner-Volume1-ambienti-urbani-desktop");
    var progressFrame = spinner.querySelector(".progress-frame-Volume1-ambienti-urbani-desktop");
    ...
    document.querySelector(".slider-Volume1-ambienti-urbani-desktop").style.opacity = "1";
    document.querySelector(".details-Volume1-ambienti-urbani-desktop").style.opacity = "1";
  }
