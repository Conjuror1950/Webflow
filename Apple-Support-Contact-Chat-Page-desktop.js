(function(){
  ...
  .apple-contact-field {
    position: relative;
    padding-top: 8px; /* spazio per la label */
  }
  ...
  function buildForm(){
    ...
    function attachFloatingLabelBehavior(input){
      ...
      // stato iniziale se già valorizzato (es. valori precompilati)
      ...
      input.addEventListener('input', () => {
        ...
        if(input.value && input.value.trim() !== '') {
          ...
          // se è vuoto ma siamo ancora in focus la label resta up (focus listener gestione)
          // togliamo active solo se NON siamo in focus
    ...
    form.addEventListener('submit', function(e){
      ...
      // simulazione invio — sostituisci con chiamata reale se necessario
      setTimeout(()=>{
