// Player-Video-Uno-sguardo-in-anteprima-mobile.js
(() => {
  const init = () => {
    // --- CSS ---
    const style = document.createElement('style');
    style.textContent = `
      .container-player-video-uno-sguardo-in-anteprima-mobile {
        width: min(960px, 100%);
        display: none; /* NASCONDI IL PLAYER INIZIALMENTE */
      }
      
      .video-wrap-player-video-uno-sguardo-in-anteprima-mobile {
        position: relative;
        overflow: hidden;
      }
    ...
    root.className = 'page-player-video-uno-sguardo-in-anteprima-mobile';
    root.innerHTML = `
      <div class="container-player-video-uno-sguardo-in-anteprima-mobile" id="videoContainer-player-video-uno-sguardo-in-anteprima-mobile">
          <div class="video-wrap-player-video-uno-sguardo-in-anteprima-mobile" id="videoWrap-player-video-uno-sguardo-in-anteprima-mobile">
            <video id="Player-video-uno-sguardo-in-anteprima-mobile" controls controlsList="share" allow="picture-in-picture" x-webkit-airplay="allow" data-no-toggle preload="metadata" crossorigin="anonymous">
            </video>
          </div>
      </div>
    `;
    ...
    // --- JS ---
const showPlayer = () => {
  const container = document.getElementById('videoContainer-player-video-uno-sguardo-in-anteprima-mobile');
  container.style.display = 'block';

  const video = document.getElementById('Player-video-uno-sguardo-in-anteprima-mobile');
  if (video) {
    ...
    const lightbox = document.getElementById('Open-Player-Video-Uno-sguardo-in-anteprima-container-mobile');
    if (lightbox) {
    ...
    const videoWrap = document.getElementById('videoWrap-player-video-uno-sguardo-in-anteprima-mobile');
...
const iosVideo = document.getElementById('Player-video-uno-sguardo-in-anteprima-mobile');
if (iosVideo) {
  ...
  const initDashPlayer = () => {
    const videoEl = document.getElementById('Player-video-uno-sguardo-in-anteprima-mobile');
    if (!videoEl) {
